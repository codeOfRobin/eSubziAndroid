...
import com.rajat.e_subzi.Tools.MultipartyRequest;
        ...
        import com.rajat.e_subzi.Volley.VolleySingleton;
...
public class MultipartActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MultipartyRequest multipartRequest = new MultipartyRequest(url, null, mimeType, multipartBody, new Response.Listener<NetworkResponse>() {
            @Override
